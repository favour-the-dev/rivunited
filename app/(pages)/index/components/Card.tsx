...
function Card({imageSrc, NewsHeadline, Team}: CardProps) {
    return ( 
        <>
            <div className="flex md:flex-col gap-2 md:gap-0 md:items-start md:w-full md:max-w-[300px] py-4 border-b border-opacity-85 md:border-none">
                {/* <Image
                src={imageSrc}
                alt=""
                width={250}
                height={250}
                className="md:w-full" */}
                <img src={imageSrc} alt="" className="w-[150px] h-[100px] md:h-[200px] md:max-w-[300px] md:w-full"/>
